...
<template>
    <AuthBase class="" title="Buat akun" description="Masukkan detail Anda di bawah ini untuk membuat akun Anda.">
            ...
            <div class="grid grid-cols-1 gap-y-6 md:grid-cols-2 md:gap-x-4">
                <div class="w-full space-y-3 md:max-w-md">
                    <div class="grid gap-2">
                        ...
                        <Input id="nik" type="text" required autofocus :tabindex="1" autocomplete="nik" name="nik"
