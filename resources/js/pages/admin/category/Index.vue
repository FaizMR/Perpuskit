        ...
        <div class="md:mx-auto mt-10 max-w-sm md:max-w-6xl overflow-x-auto md:mt-5">
            ...
            <Card class="border-transparent mt-2">
                <CardContent>
                                    ...
                                    <Popover>
                                        ...
                                        <PopoverContent>
                                            <div class="flex flex-col">
                                                ...
                                                <select id="perPage" v-model="perPage" @change="updateCategory"
                    ...
                    <DataTable :columns="columns" :data="props.categories.data" :links="props.categories.links"
                        :current_page="props.categories.current_page" :per_page="props.categories.per_page" :filters="{
                            search: searchQuery,
                        ...
                        <template #actions="{ item: categories }">
                            <div class="flex items-center gap-2">
                                ...
                                <div class="group relative inline-block">
                                    <!-- Hapus -->
                                    <Dialog v-model:open="isOpen[categories.id]" :key="categories.id">
