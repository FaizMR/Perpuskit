        ...
        <div class="md:mx-auto mt-10 max-w-sm md:max-w-6xl overflow-x-auto md:mt-5">
            ...
            <Card class="border-transparent mt-2">
                <CardContent>
                    <div class="flex flex-col items-stretch justify-between gap-4 sm:flex-row sm:items-center">
                        <div class="flex items-end gap-2">
                            <Input id="searchQuery" class="w-full sm:w-64" v-model="searchQuery"
                                placeholder="Cari..." />
                            <select id="searchBy" v-model="searchBy" @change="updateDataBukus"
                    ...
                    <DataTable :columns="columns" :data="books.data" :links="books.links"
                        :current_page="props.books.current_page" :per_page="props.books.per_page" :filters="{
                            search: searchQuery,
                        ...
                        <template #actions="{ item: databukus }">
                            <div class="flex items-center gap-2">
                                ...
                                <div class="group relative inline-block">
                                    <!-- Hapus -->
                                    <Dialog v-model:open="isOpen[databukus.id]" :key="databukus.id">
