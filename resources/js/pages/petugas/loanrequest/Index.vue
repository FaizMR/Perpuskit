...
const props = defineProps<{
    LoanRequest: PaginatedResponse<PengajuanPeminjaman>;
}>();
console.log(props.LoanRequest);
const pagination = computed(() => ({
    previous: props.LoanRequest.prev_page_url,
    next: props.LoanRequest.next_page_url,
}));
        ...
        <div class="md:mx-auto mt-10 max-w-sm md:max-w-6xl overflow-x-auto md:mt-5">
            ...
            <Card class="border-transparent mt-2">
                <CardContent>
                    <div class="flex flex-col items-stretch justify-between gap-4 sm:flex-row sm:items-center">
                        <div class="flex items-end gap-2">
                            <Input id="searchQuery" class="w-full sm:w-64" v-model="searchQuery"
                                placeholder="Cari..." />
                            <select id="searchBy" v-model="searchBy" @change="updatepengajuanpeminjamans"
                    ...
                    <DataTable :columns="columns" :data="LoanRequest.data" :links="LoanRequest.links"
                        :current_page="props.LoanRequest.current_page" :per_page="props.LoanRequest.per_page" :filters="{
                            search: searchQuery,
                        ...
                        <template #actions="{ item: pengajuanpeminjamans }">
                            <div class="flex items-center gap-2">
                                <div class="group relative inline-block">
                                    <!-- Show -->
                                    <Link :href="show(pengajuanpeminjamans.id)" as="button">
                                ...
                                <Dialog v-model:open="isOpen[pengajuanpeminjamans.id]
                                ...
                                <Dialog v-model:open="isOpenBatal[pengajuanpeminjamans.id]
