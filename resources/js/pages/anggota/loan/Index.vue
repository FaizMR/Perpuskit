        ...
        <div class="md:mx-auto mt-10 max-w-sm md:max-w-6xl overflow-x-auto md:mt-5">
            ...
            <Card class="border-transparent mt-2">
                <CardContent>
                    <div class="flex flex-col items-stretch justify-between gap-4 sm:flex-row sm:items-center">
                        <div class="flex items-end gap-2">
                            <Input id="searchQuery" class="w-full sm:w-64" v-model="searchQuery"
                                placeholder="Cari..." />
                            <select id="searchBy" v-model="searchBy" @change="updatePeminjamanBukus"
                                ...
                                <Popover>
                                    ...
                                    <PopoverContent>
                                        <div class="flex flex-col">
                                            <Label for="categorySearch" class="mb-2">Kategori</Label>
                                            <select id="categorySearch" v-model="categorySearch"
                    ...
                    <DataTable :columns="columns" :data="BookLoan.data" :links="BookLoan.links"
                        :current_page="props.BookLoan.current_page" :per_page="props.BookLoan.per_page" :filters="{
                            search: searchQuery,
                        ...
                        <template #actions="{ item: peminjamanbukus }">
                            <div class="flex items-center gap-2">
                                <div class="group relative inline-block">
                                    <!-- Show -->
                                    <Link :href="show(peminjamanbukus.id)" as="button">
                                ...
                                <Dialog v-model:open="isOpen[peminjamanbukus.id]" :key="peminjamanbukus.id">
                                    ...
                                    <DialogContent class="sm:max-w-xl">
                                        <DialogHeader>
                                            ...
                                            <Textarea id="catatan" class="mt-5 w-full" v-model="catatan"
                                                placeholder="Catatan..." />
                                        </DialogHeader>
