        ...
        <div class="md:mx-auto mt-10 max-w-sm md:max-w-6xl overflow-x-auto md:mt-5">
            ...
            <Card class="border-transparent mt-2">
                <CardContent>
                    <div class="flex flex-col items-stretch justify-between gap-4 sm:flex-row sm:items-center">
                        <div class="flex items-end gap-2">
                            <Input id="searchQuery" class="w-full sm:w-64" v-model="searchQuery"
                                placeholder="Cari..." />
                            <select id="searchBy" v-model="searchBy" @change="updateDaftarKeterlambatans"
                    ...
                    <DataTable :columns="columns" :data="Overdues.data" :links="Overdues.links"
                        :current_page="props.Overdues.current_page" :per_page="props.Overdues.per_page" :filters="{
                            search: searchQuery,
                        ...
                        <template #action="{ item: daftarketerlambatans }">
                            <div class="flex items-center gap-2">
                                <div class="group relative inline-block">
                                    <Link :href="show(daftarketerlambatans.id)" as="button">
