        ...
        <div class="mx-auto mt-5 max-w-6xl overflow-x-auto">
            ...
            <Card class="border-transparent">
                <CardContent>
                                ...
                                <Popover>
                                    ...
                                    <PopoverContent
                                        ><div class="flex flex-col">
                                            <!-- <Label for="statusSearch" class="mb-5"
                                        >Status</Label
                                    >
                                    <select
                                        id="statusSearch"
                    ...
                    <DataTable
                        :columns="columns"
                        :data="loanResource.data"
                        :links="loanResource.links"
                        :current_page="props.loanResource.current_page"
                        :per_page="props.loanResource.per_page"
                        :filters="{
                            search: searchQuery,
